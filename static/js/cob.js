...
function COB(params){
    ...
    $('#cob .OntologyTable tbody').on('click','tr', function() {
        ...
        .ajax.url($SCRIPT_ROOT + 'Ontology/Terms/' + name).load().draw()
    ...
    $('#cob .NetworkTable tbody').on('click','tr',function(){
        ...
        $.getJSON($SCRIPT_ROOT + 'COB/' + cob.menu.LoadedNetwork + '/' + cob.menu.LoadedOntology + '/' + cob.menu.LoadedTerm)
            .done(function(data){
    ...
    this.load_annotations = function(){
        ...
        try{
            // Fetch ajax
            $.getJSON($SCRIPT_ROOT + 'Annotations/' + cob.menu.LoadedNetwork + '/' + cob.menu.LoadedOntology + '/' + cob.menu.LoadedTerm + '?genes=' + node_ids.join(','))
            .success(
                function(data){
                    data.name = 'LociTable'
